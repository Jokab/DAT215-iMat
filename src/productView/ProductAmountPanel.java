...
public class ProductAmountPanel extends JPanel {
	...
	private final JButton increaseButton = new JButton(new ImageIcon("img/plusIcon.png"));
	private final JButton decreaseButton = new JButton(new ImageIcon("img/minusIcon.png"));
